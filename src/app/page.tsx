        ...
        <div className="flex justify-between mx-6 mb-10 mt-4">
          <ul className="inline-flex gap-3">
            <button onClick={() => handleCourseType('Extensão')}>
              <li
                className={`font-regular text-lg max-sm:text-sm ${courseType === 'Extensão' ? 'border-b-[3px] border-darkBlue' : ''}`}
              >
                Extensão
              </li>
            </button>
            <button onClick={() => handleCourseType('Ensino')}>
              <li
                className={`font-regular text-lg max-sm:text-sm ${courseType === 'Ensino' ? 'border-b-[3px] border-darkBlue' : ''}`}
              >
                Ensino
              </li>
            </button>
